...
## Acceptance Criteria
- [ ] STORY-UL17 fulfilled (FEAT-UL17 maintained after an independent agent review)
- [ ] Notebooks 19a_normalizing_flows_theory.ipynb, 19b_normalizing_flows_practical.ipynb committed with execution outputs, zero errors
