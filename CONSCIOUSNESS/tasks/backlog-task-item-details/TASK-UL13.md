...
## Acceptance Criteria
- [x] Manifold hypothesis and local/global structure preservation
- [x] Neighborhood graphs and k-NN construction
- [x] SNE: Symmetric SNE derivation and gradient descent
- [x] t-SNE: Student-t kernel, why it works better than Gaussian
- [x] Perplexity parameter and its interpretation
- [x] UMAP: Fuzzy topological spaces and graph layout
- [x] UMAP vs t-SNE: differences in approach and results
- [x] Caveats about visualization artifacts (clustering may be artificial)
- [x] From-scratch NumPy implementation of simplified t-SNE
